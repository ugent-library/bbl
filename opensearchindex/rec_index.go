...
func newRecIndex[T bbl.Rec](
	...
	if err := opensearchswitcher.Init(ctx, client, alias, strings.NewReader(settings), 1); err != nil {
		return nil, err
	}
...
func (idx *recIndex[T]) NewSwitcher(ctx context.Context) (bbl.IndexSwitcher[T], error) {
