...
export default function (rootEl) {
    ...
    rootEl.querySelectorAll("[data-bb-tags]").forEach((tags) => {
        const values = tags.querySelector("[data-bb-tags-values]");
        const widgetValues = tags.querySelector("[data-bb-tags-widget-values]");
        ...
        // parse json, and fill tags-real-values
        {
            ...
            try {
                ...
                if (Array.isArray(val)) {
                    fillRealValues(values, inputName, val);
                }
            } catch (err) { }
        }
...
function fillRealValues(element, name, values) {
    element.innerHTML = "";
